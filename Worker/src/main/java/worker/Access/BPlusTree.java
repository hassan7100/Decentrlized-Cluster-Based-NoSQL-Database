...
public class BPlusTree<K extends Comparable<? super K>, V> {
	...
	private BPlusTree(int branchingFactor) {
	...
	public static BPlusTree getBPlusTree(int branchingFactor){
		if(bPlusTree == null){
			bPlusTree = new BPlusTree<>(branchingFactor);
		}
		return bPlusTree;
	}
